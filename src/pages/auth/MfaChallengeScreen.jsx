  ...
  return (
    <div style={styles.outer}>
      <style>{`
        ...
        .mfa-signout:hover { text-decoration: underline; color: var(--primary, #2563EB); }
      `}</style>
...
const styles = {
  ...
  codeInput: {
    width: "100%", marginTop: 6, padding: "10px 12px", borderRadius: 8, border: "1px solid #CBD5E1",
    fontSize: 20, letterSpacing: "0.5em", textAlign: "center", color: "#10142A", boxSizing: "border-box",
    fontFamily: "monospace", transition: "border-color .12s ease",
  },
  errorBox: {
    background: "#FDECEC", color: "#EF4444", fontSize: 12.5, padding: "10px 12px", borderRadius: 8,
