...
export const PLAN_TIERS = {
  ...
  growth: {
    ...
    priceEUR: 440,
    period: "month",
    seatLimit: "30 included (max 150 seats)",
    popular: true,
    badge: "Most Popular",
    color: "var(--primary, #2563EB)",
    features: [
      { text: "Multiple Admin & Instructor seats", included: true },
      { text: "30 learner seats included (expandable up to 150 max seats)", included: true },
  ...
  enterprise: {
    ...
    priceEUR: null,
    period: "custom",
    seatLimit: "150+ / Custom volume",
    popular: false,
    badge: "Enterprise",
    color: "#0F172A",
    features: [
      { text: "Multiple Admin, Manager & Instructor seats", included: true },
      { text: "150+ seats & bespoke enterprise volume", included: true },
