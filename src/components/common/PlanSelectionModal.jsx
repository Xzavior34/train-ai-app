...
export const PLAN_TIERS = {
  ...
  growth: {
    ...
    priceEUR: 440,
    period: "month",
    seatLimit: "30 learners included",
    popular: true,
    badge: "Most Popular",
    color: "var(--primary, #2563EB)",
    features: [
      { text: "Multiple Admin & Instructor seats", included: true },
      { text: "30 learner seats included", included: true },
      { text: "Additional seats at ₦10,000 / $10 per seat", included: true },
      { text: "400 AI credits for entire organisation", included: true },
  ...
  enterprise: {
    ...
    features: [
      ...
      { text: "Unlimited learner seats & custom volume", included: true },
