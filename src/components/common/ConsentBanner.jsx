...
function MiniSwitch({ on, onChange, disabled }) {
  return (
    <div
      ...
      aria-checked={on}
      style={{
        width: 36, height: 21, borderRadius: 99, background: on ? "var(--primary, #2563EB)" : "var(--primary-tint, #EFF6FF)",
...
const ghostBtnStyle = {
  border: "none", cursor: "pointer", borderRadius: 8, fontWeight: 700, fontSize: 12.5, padding: "9px 14px",
  background: "var(--primary-tint, #EFF6FF)", color: "var(--primary, #2563EB)"
};
    ...
    >
      ...
      >
        <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
          <div style={{
            width: 36, height: 36, borderRadius: "50%", background: "var(--primary-tint, #EFF6FF)",
            display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0
          }}>
            <Cookie size={17} color="var(--primary, #2563EB)" />
          </div>
