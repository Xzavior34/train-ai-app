...
function MiniSwitch({ on, onChange }) {
  return (
    <div
      ...
      aria-checked={on}
      style={{
        width: 38, height: 22, borderRadius: 99, background: on ? "var(--primary, #2563EB)" : "var(--primary-tint, #EFF6FF)",
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <Accessibility size={18} color="var(--primary, #2563EB)" />
        ...
        <div style={{ marginTop: 18 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13.5, fontWeight: 700, color: "#10142A" }}>
            <Type size={14} color="var(--primary, #2563EB)" /> Text size
          </div>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer", border: active ? "1.5px solid var(--primary, #2563EB)" : "1.5px solid #E6E9F5",
                    background: active ? "var(--primary-tint, #EFF6FF)" : "#FFFFFF", color: active ? "var(--primary, #2563EB)" : "#10142A"
                  }}
                >
                  {label}
                </button>
        ...
        <div style={{ marginTop: 18, display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
          <div style={{ minWidth: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13.5, fontWeight: 700, color: "#10142A" }}>
              <Eye size={14} color="var(--primary, #2563EB)" /> High contrast
            </div>
        ...
        <div style={{ marginTop: 16, display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
          <div style={{ minWidth: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13.5, fontWeight: 700, color: "#10142A" }}>
              <Activity size={14} color="var(--primary, #2563EB)" /> Reduce motion
            </div>
