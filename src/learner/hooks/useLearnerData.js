...
import {
  ...
  fetchPublishedLessonCounts, fetchCourseReviewSummaries,
...
import { fetchMyPersonalization } from "../../lib/api/auth.js";
import {
  fetchCommunityPosts,
  ...
  const courses = (() => {
    ...
    return (coursesQuery.data || []).map((c, i) => {
      ...
      return {
        ...
        reviews: summary ? summary.count : 0,
        enrolled: !!enrollment,
