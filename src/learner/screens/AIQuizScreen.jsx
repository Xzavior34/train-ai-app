...
import { TopBar, StatTile, optionLabel, optionValue } from "../components/LearnerUI.jsx";
import { Trophy, Flame, Zap, Award, Target, HelpCircle, CheckCircle2, ChevronRight, GraduationCap, Sparkles } from "lucide-react";
...
export function AIQuizScreen({
  ...
  return (
    <div className="tai-fade-in">
      <TopBar title="AI Quiz & Practice" sub="Adaptive questions & insights" />
      <div className="tai-row tai-gap8">
        {["quiz", "history", "insights"].map(t => (
          <div key={t} className={`tai-pill ${aiTab === t ? "tai-pill-active" : "tai-pill-inactive"}`} onClick={() => setAiTab(t)}>
