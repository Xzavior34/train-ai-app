...
import { Send, Search, BookOpen, CheckCheck, X } from "lucide-react";
  ...
  return (
    <div className="ta-fade">
      ...
      <div className="ta-content">
        <div className="ta-card" style={{ padding: 0, overflow: "hidden", display: "grid", gridTemplateColumns: "320px 1fr", minHeight: 600 }}>

          {/* Left Sidebar: Find Learners & Conversation List */}
          <div style={{ borderRight: "1px solid var(--border)", background: "var(--surface-3)", display: "flex", flexDirection: "column" }}>
