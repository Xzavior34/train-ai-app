...
export function MentorScheduleScreen({ mentorId, orgSelector }) {
  ...
  return (
    <div className="ta-fade">
      <TopBar title="Mentorship Schedule & Sessions" sub="Manage 1:1 sessions, student requests & recurring availability" orgSelector={orgSelector} />
        ...
        {tab === "sessions" && (
          <>
            ...
            <div className="ta-col ta-gap12 ta-mt16">
              {!mentorId && <div className="ta-empty">Your instructor profile isn't linked to a mentor record yet.</div>}
              ...
              {filteredSessions.map(s => (
                <div key={s.id} className="ta-card ta-row ta-between" style={{ flexWrap: "wrap", gap: 16 }}>
                  <div className="ta-row ta-gap14">
                    ...
                    <div>
                      <div style={{ fontWeight: 800, fontSize: 15 }}>{s.title || "Mentorship Session"}</div>
        ...
        {tab === "availability" && (
          <>
            <div className="ta-card ta-mt16" style={{ maxWidth: 560 }}>
              ...
              {!mentorId && <div className="ta-empty" style={{ padding: "10px 0 0" }}>Your instructor profile isn't linked to a mentor record yet.</div>}
            </div>
