                ...
                <tbody>
                  ...
                  {earnings.map(e => (
                    <tr key={e.id}>
                      ...
                      <td><Tag tone={e.status === "available" || e.status === "paid" ? "success" : e.status === "pending" ? "warning" : undefined}>{e.status || "—"}</Tag></td>
                ...
                <tbody>
                  ...
                  {(payoutsQuery.data || []).map(p => (
                    <tr key={p.id}>
                      ...
                      <td style={{ textTransform: "capitalize" }}>{(p.payment_method?.type || "—").replace(/_/g, " ")}</td>
