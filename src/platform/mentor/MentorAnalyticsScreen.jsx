...
import { 
  ...
  MessageCircle, CheckCircle2, Award, Sparkles, ThumbsUp,
            ...
            <div className="ta-hero-text">
              <div className="ta-row ta-gap10" style={{ flexWrap: "wrap", marginBottom: 8 }}>
                <span style={{
                  ...
                  <Award size={13} color="#A5B4FC" /> TOP RATED INSTRUCTOR
                </span>
                <span style={{
                  ...
                  <ThumbsUp size={11} color="#34D399" /> 98.4% POSITIVE SENTIMENT
                </span>
              </div>
