...
export const TOKENS = `
  ...
  .ta-tabs { display: flex; gap: 6px; border-bottom: 1px solid var(--border); }
  .ta-tab { padding: 10px 4px; margin-right: 18px; font-size: 13.5px; font-weight: 700; color: var(--text-2); cursor: pointer; border-bottom: 2.5px solid transparent; }
...
const WORKSPACES = [
  ...
  { key: "mentor", label: "Instructor View", subtitle: "Mentor Portal", icon: GraduationCap, roles: ["mentor", "admin", "super_admin"] },
  ...
  { key: "superadmin", label: "Super Admin", subtitle: "Platform Control", icon: ShieldCheck, roles: ["super_admin"] },
];
...
export function Sidebar({ workspace, setWorkspace, screen, setScreen, mobileOpen, onClose, onSwitchToLearner, userRoles = ["admin", "mentor", "super_admin"] }) {
        ...
        <div className="ta-nav-footer">
          {onSwitchToLearner && (
            <div
              ...
              onClick={() => { onSwitchToLearner(); onClose(); }}
            >
              <Repeat size={16} />
  ...
  return (
    <div className="ta-topbar">
      ...
      <div className="ta-topbar-right">
        ...
        {orgSelector && (
          <div className="ta-row ta-gap8" style={{
