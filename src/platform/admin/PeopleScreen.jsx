...
import { UserPlus, Search, Check, X, ShieldAlert, Download, Trash2, FileText } from "lucide-react";
import { useSupabaseQuery } from "../../lib/useSupabaseQuery.js";
import { fetchOrgMembers, fetchMentorApplications, fetchPendingInvitations, createInvitation, revokeInvitation, decideMentorApplication, updateOrgMemberStatus } from "../../lib/api/platform.js";
...
export function PeopleScreen({ orgId, orgSelector, setScreen }) {
  ...
  return (
    <div className="ta-fade">
      <TopBar
        title="People & Access" sub="Directory, mentor applications & invitations"
      ...
      <div className="ta-content">
        <div className="ta-tabs">
          {[{ k: "all", label: "Directory" }, { k: "applications", label: `Applications (${applications.length})` }, { k: "invites", label: `Pending Invites (${invitations.length})` }, { k: "dsar", label: `Data Requests (${pendingDsarCount})` }].map(t => (
          ...
          <div className="ta-card ta-mt16">
            <table className="ta-table">
              ...
              <tbody>
                ...
                {!applicationsQuery.loading && applications.length === 0 && <tr><td colSpan={4} className="ta-empty">No pending mentor applications.</td></tr>}
                {applications.map(a => (
                  <tr key={a.id}>
